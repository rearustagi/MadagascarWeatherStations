...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Madagascar Weather Stations",
    Description = "A data pipeline and distribution package for our Madagascar weather stations data.",
    `Authors@R` = c(
      person("Tinashe", "Tapera", middle = "Michael", email = "ttapera@hsph.harvard.edu", role = c("aut", "cre"))
    )  
  ),
  overwrite = TRUE
)
# Define License with use_*_license()
usethis::use_mit_license("Tinashe Michael Tapera")
```
...
# Code of Conduct
usethis::use_code_of_conduct("ttapera@hsph.harvard.edu")
# NEWS
usethis::use_news_md()
```
...
# Extra Packages for VSCode, `renv`, and `targets`

```{r}
install.packages(c(
  "languageserver", # R language server
  "rlang", # language server support
  "jsonlite", # JSON support
  "remotes", # VSCode R tools
  "config", # for fusen config mgmt
  "parsermd"
))
